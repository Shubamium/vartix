    ...
    <main id="p_faq">
      <div id="fh">
        <div className="confine">
          ...
          <p>
            Have a question? You’re not alone! Here are answers to some of the
            most common things people ask us — from how the process works to
            what formats we support. If you don’t find what you’re looking for,
      ...
      <div id="fl">
        ...
        {faq.faq?.map((faq, i) => (
          <Dropdown key={i} question={faq.question} answer={faq.answer} />
        ))}
      </div>
    </main>
  );
